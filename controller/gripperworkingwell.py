...
pinForward = 17  # Pin do tylu (GPIO 17)
pinBackward = 27 # Pin do przodu (GPIO 27)
...
motor_forward(0.3)  # Jedź do przodu z połową prędkości
import time
time.sleep(2)  # Czekaj 2 sekundy
motor_backward(0.3)  # Jedź do tyłu z mniejszą prędkością
time.sleep(2)  # Czekaj 2 sekundy
